...
function AICustomModal() {
  ...
  switch (currentAIName) {
    ...
    case "유도 미사일": Image = 블레이즈서포터; Tag = "아이스 볼트로 적을 지정하면 원을 그리며 회전 & 일반적인 펫 미사일 사용도를 강화, 빠른 복귀 트리거 구비";
      FuncList = ["윈드밀 반응 복귀", "자동 신속 발동",];
      Explain = '몽라, 시드 같은 곳에서 펫의 위치를 정하는 일은 아주.....성가십니다. 이럴 땐 복합적인 AI를 사용하기보다는 말 잘듣는 단순한 녀석이 빛을 발하죠. 유도 미사일 AI가 바로 그러합니다. 주인이 아볼트를 장전하면 주인 곁에서 대기, 주인이 사격한 대상 주변 원을 그리며 어그로를 끕니다. 그게 아니라 일반적인 펫 미사일이 필요하시다면 그냥 사용하셔도 됩니다! 유도 미사일 AI는 주인이 호출하거나 사망하기 전까지 무한 평타를 보장합니다.'; break;
