...
function ExplainModal() {
  ...
  switch (currentAIName) {
    ...
    case "로드롤러": Image = 로드롤러; Tag = "주인의 위치에서 윈드밀로 적의 공격을 반격";
      ...
      Explain = '제자리에 굳건히 서서 온갖 귀찮은 것들을 쓸어버리는 화력전을 선호하신다면, 펫 디펜더 대신 이 AI가 더 매력적일 것입니다. 방어에 완전히 집중한 이 AI는 디펜스 대신 윈드밀을 사용하여 적의 범위형 평타를 완전히 반격합니다. 어쩌다 한 번 맞는 것 마저 싫다면, 로드롤러가 회전하게 두십시오!'; break;
